...
for i=1:num_neg_examples
    ...
    if (activation >= 0)
        %YOUR CODE HERE
        %if the activation is greater than 0, and shouldn't be expected
         %we will subtract the input vector from the weight vector
         w = w-this_case'; 
    end
end
for i=1:num_pos_examples
    ...
    if (activation < 0)
        %YOUR CODE HERE
        %if the activation is less than 0, and shouldn't be expected
         %we will add the input vector from the weight vector
        w = w + this_case';
    end
end
